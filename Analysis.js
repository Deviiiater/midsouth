...
document.getElementById("toggleTableexpenss").addEventListener("click", function () {
  var table = document.getElementById("investmentTableexpenss");
  if (table.style.display === "none") {
      table.style.display = "table";
  } else {
      table.style.display = "none";
...
document.getElementById("toggleTable3").addEventListener("click", function () {
  var table = document.getElementById("investmentTable3");
  if (table.style.display === "none") {
      table.style.display = "table";
  } else {
      table.style.display = "none";
...
document.getElementById("toggleTable4").addEventListener("click", function () {
...
function populateTable4() {
 ...
 for (let i = 0; i < 30; i++) {
  let row = document.createElement("tr")
      row.innerHTML = `
          <td> ${formatMoneyWithSeparator(Math.round(property_cashflow[i]))}</td>
      `;
      // log
      tbody.appendChild(row);
 }
